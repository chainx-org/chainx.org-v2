  ...
  return (
    <PlatSection>
      <InnerSection className="platforms">
        <Item
          key="amache2"
          className="ani2 animate__animated animate__fadeInUp"
        >
          <IntlContextConsumer>
            {({ languages, language: currentLocale }) => (
              <PlatMain className="anishow1">
                ...
                <PlatCon
                  style={{ display: 'zh' === currentLocale ? 'block' : 'none' }}
                >
                  ChainX将基于比特币网络开展Layer2衍生平台的研究和拓展，旨在促进比特币价值流动、丰富比特币衍生应用及完善比特币投资对冲工具。
                </PlatCon>
                <PlatCon
                  style={{ display: 'en' === currentLocale ? 'block' : 'none' }}
                >
                  ChainX is deeply committed to researching and expanding
                  Bitcoin’s Layer 2 financial platform, striving to promote
                  Bitcoin’s value flow, enrich financial derivative
                  opportunities and improve hedging tools.
                </PlatCon>
                <PlatCon
                  style={{ display: 'tr' === currentLocale ? 'block' : 'none' }}
                >
                  ChainX, Bitcoin'in Değer akışını teşvik etmek, finansal türev
                  fırsatlarını zenginleştirmek ve riskten korunma araçlarını
                  geliştirmek için Bitcoin’in Katman 2 finansal platformunu
                  araştırmaya ve genişletmeye derinden bağlıdır.
                </PlatCon>
              </PlatMain>
            )}
          </IntlContextConsumer>
        ...
        <Item className="picCon ani3">
          ...
          <PlatMain className="anishow2">
            <PlatTit>
              {intl.formatMessage({ id: 'Digital asset gateway' })}
            </PlatTit>
            <PlatCon>
              {intl.formatMessage({
                id:
                  'The ChainX asset gateway is composed of two parts: decentralized Bitcoin trusteeship and inter-chain asset mirroring.',
              })}
            </PlatCon>
            <PlatCon>
              {intl.formatMessage({
                id:
                  'Users deposit and collateralize Bitcoin for X-BTC and use this in transactions with synthetic assets of other cryptocurrencies, growing to a wide range of cryptocurrencies that can be exchanged and traded on the same chain.',
              })}
            </PlatCon>
          </PlatMain>
        </Item>
        <Item className="ani4">
          <PlatMain className="anishow3">
            <PlatTit>
              {intl.formatMessage({ id: 'Polkadot second-layer relay chain' })}
            </PlatTit>
            <PlatCon>
              {intl.formatMessage({
                id:
